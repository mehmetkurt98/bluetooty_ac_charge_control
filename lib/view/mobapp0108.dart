          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButton<BluetoothDevice>(
                ...
                hint: Container(alignment: Alignment.center,child: Text("Cihaz Seçin",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(chargerStatus, style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white)),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton(   //Burada bir mantık hatası olabilir kontrol et.
                            onPressed: () {
                              _sendData(0);
